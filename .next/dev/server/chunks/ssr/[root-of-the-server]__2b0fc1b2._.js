...
const metadata = {
    ...
    description: "Gestor de contraseñas Zero-Knowledge con cifrado end-to-end en el navegador. AES-256-GCM, Argon2id, RSA-OAEP, ECDH. El servidor nunca ve tus secretos.",
    keywords: [
        "zero-knowledge",
        "password manager",
        "encryption",
    ...
    openGraph: {
        ...
        description: "Gestor de contraseñas Zero-Knowledge con cifrado end-to-end en el navegador.",
        type: "website"
    },
    twitter: {
