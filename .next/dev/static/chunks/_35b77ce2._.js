...
"[project]/src/lib/pq-kem-real.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$ml$2d$kem$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@noble/post-quantum/ml-kem.js [app-client] (ecmascript)");
;
...
class MLKEM768KEM {
    generateKeyPair() {
        const { secretKey, publicKey } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$ml$2d$kem$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ml_kem768"].keygen();
        return {
            publicKey,
    ...
    encapsulate(publicKey) {
        const { cipherText, sharedSecret } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$ml$2d$kem$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ml_kem768"].encapsulate(publicKey);
        return {
    ...
    decapsulate(privateKey, ciphertext) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$ml$2d$kem$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ml_kem768"].decapsulate(privateKey, ciphertext);
    }
...
"[project]/node_modules/@noble/hashes/sha3.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const IOTAS = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$_u64$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["split"])(_SHA3_IOTA, true);
...
const rotlH = (h, l, s)=>s > 32 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$_u64$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rotlBH"])(h, l, s) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$_u64$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rotlSH"])(h, l, s);
const rotlL = (h, l, s)=>s > 32 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$_u64$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rotlBL"])(h, l, s) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$_u64$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rotlSL"])(h, l, s);
function keccakP(s, rounds = 24) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["anumber"])(rounds, 'rounds');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clean"])(B);
}
class Keccak {
    state;
    pos = 0;
    ...
    constructor(blockLen, suffix, outputLen, enableXOF = false, rounds = 24){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["anumber"])(outputLen, 'outputLen');
        // 1600 = 5x5 matrix of 64bit.  1600 bits === 200 bytes
        // 0 < blockLen < 200
        if (!(0 < blockLen && blockLen < 200)) throw new Error('only keccak-f1600 function is supported');
        this.state = new Uint8Array(200);
        this.state32 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["u32"])(this.state);
    }
    clone() {
        return this._cloneInto();
    }
    keccak() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["swap32IfBE"])(this.state32);
    ...
    writeInto(out) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aexists"])(this, false);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(out);
        this.finish();
    ...
    xof(bytes) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["anumber"])(bytes);
    ...
    destroy() {
        this.destroyed = true;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clean"])(this.state);
    }
    _cloneInto(to) {
...
const genKeccak = (suffix, blockLen, outputLen, info = {})=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createHasher"])(()=>new Keccak(blockLen, suffix, outputLen), info);
const sha3_224 = /* @__PURE__ */ genKeccak(0x06, 144, 28, /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["oidNist"])(0x07));
const sha3_256 = /* @__PURE__ */ genKeccak(0x06, 136, 32, /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["oidNist"])(0x08));
const sha3_384 = /* @__PURE__ */ genKeccak(0x06, 104, 48, /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["oidNist"])(0x09));
const sha3_512 = /* @__PURE__ */ genKeccak(0x06, 72, 64, /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["oidNist"])(0x0a));
...
const genShake = (suffix, blockLen, outputLen, info = {})=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createHasher"])((opts = {})=>new Keccak(blockLen, suffix, opts.dkLen === undefined ? outputLen : opts.dkLen, true), info);
const shake128 = /* @__PURE__ */ genShake(0x1f, 168, 16, /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["oidNist"])(0x0b));
const shake256 = /* @__PURE__ */ genShake(0x1f, 136, 32, /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["oidNist"])(0x0c));
const shake128_32 = /* @__PURE__ */ genShake(0x1f, 168, 32, /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["oidNist"])(0x0b));
const shake256_64 = /* @__PURE__ */ genShake(0x1f, 136, 64, /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["oidNist"])(0x0c)); //# sourceMappingURL=sha3.js.map
}),
"[project]/node_modules/@noble/curves/abstract/fft.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@noble/post-quantum/utils.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * @module
 */ /*! noble-post-quantum - MIT License (c) 2024 Paul Miller (paulmillr.com) */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@noble/hashes/utils.js [app-client] (ecmascript)");
;
/**
 ...
 * ```
 */ const abytesDoc = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"];
;
/**
 ...
 * ```
 */ const concatBytesDoc = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["concatBytes"];
;
const randomBytes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["randomBytes"];
...
function copyBytes(bytes) {
    // `Uint8Array.from(...)` would also accept arrays / other typed arrays. Keep this helper strict
    // because callers use it at byte-validation boundaries before mutating the detached copy.
    return Uint8Array.from((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(bytes));
}
...
const baswap64If = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isLE"] ? (arr)=>arr : byteSwap64;
...
function validateVerOpts(opts) {
    validateOpts(opts);
    if (opts.context !== undefined) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(opts.context, undefined, 'opts.context');
}
function validateSigOpts(opts) {
    validateVerOpts(opts);
    if (opts.extraEntropy !== false && opts.extraEntropy !== undefined) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(opts.extraEntropy, undefined, 'opts.extraEntropy');
}
    ...
    return {
        ...
        encode: (bufs)=>{
            ...
            for(let i = 0, pos = 0; i < lengths.length; i++){
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(b, l, label);
                res.set(b, pos);
        ...
        decode: (buf)=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(buf, bytesLen, label);
            const res = [];
...
function vecCoder(c, vecLen) {
    ...
    return {
        ...
        decode: (a)=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(a, bytesLen);
            const r = [];
...
function getMessage(msg, ctx = EMPTY) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(ctx);
    if (ctx.length > 255) throw new RangeError('context should be 255 bytes or less');
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["concatBytes"])(new Uint8Array([
        0,
        ctx.length
    ]), ctx, msg);
}
...
"[project]/node_modules/@noble/post-quantum/_crystals.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * @module
 */ /*! noble-post-quantum - MIT License (c) 2024 Paul Miller (paulmillr.com) */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$curves$2f$abstract$2f$fft$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@noble/curves/abstract/fft.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$sha3$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@noble/hashes/sha3.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@noble/post-quantum/utils.js [app-client] (ecmascript)");
;
;
;
const genCrystals = (opts)=>{
    ...
    function getZettas() {
        const out = newPoly(N);
        for(let i = 0; i < N; i++){
            const b = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$curves$2f$abstract$2f$fft$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reverseBits"])(i, brvBits);
    ...
    const dif = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$curves$2f$abstract$2f$fft$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FFTCore"])(field, {
        dit: false,
        ...nttOpts
    });
    const dit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$curves$2f$abstract$2f$fft$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FFTCore"])(field, {
        dit: true,
        ...nttOpts
    });
    const NTT = {
    ...
    const bitsCoder = (d, c)=>{
        const mask = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMask"])(d);
        ...
        return {
            ...
            encode: (poly_)=>{
                ...
                for(let i = 0, buf = 0, bufLen = 0, pos = 0; i < poly.length; i++){
                    ...
                    bufLen += d;
                    for(; bufLen >= 8; bufLen -= 8, buf >>= 8)r[pos++] = buf & (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMask"])(bufLen);
                }
                return r;
            },
            decode: (bytes)=>{
...
const createXofShake = (shake)=>(seed, blockLen)=>{
        ...
        return {
            ...
            clean: ()=>{
                h.destroy();
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cleanBytes"])(buf, _seed);
            }
        };
    };
const XOF128 = /* @__PURE__ */ createXofShake(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$sha3$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shake128"]);
const XOF256 = /* @__PURE__ */ createXofShake(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$sha3$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shake256"]); //# sourceMappingURL=_crystals.js.map
}),
"[project]/node_modules/@noble/post-quantum/ml-kem.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * @module
 */ /*! noble-post-quantum - MIT License (c) 2024 Paul Miller (paulmillr.com) */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$sha3$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@noble/hashes/sha3.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@noble/hashes/utils.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$_crystals$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@noble/post-quantum/_crystals.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@noble/post-quantum/utils.js [app-client] (ecmascript)");
;
;
;
...
const crystals = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$_crystals$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["genCrystals"])({
    N,
    Q,
    F,
    ROOT_OF_UNITY,
...
const sampleCBDBytes = (buf, eta)=>{
    ...
    const b32 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["u32"])(buf);
...
const genKPKE = (opts_)=>{
    ...
    const publicCoder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["splitCoder"])('publicKey', (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vecCoder"])(polyCoder(12), K), 32);
    const secretCoder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vecCoder"])(polyCoder(12), K);
    const cipherCoder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["splitCoder"])('ciphertext', (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vecCoder"])(polyU, K), polyV);
    const seedCoder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["splitCoder"])('seed', 32, 32);
    return {
        secretCoder,
        lengths: {
        ...
        keygen: (seed)=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(seed, 32, 'seed');
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cleanBytes"])(rho, sigma, sHat, tHat, seedDst, seedHash);
            return res;
        },
        encrypt: (publicKey, msg, seed)=>{
            ...
            for(let i = 0; i < K; i++){
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cleanBytes"])(tmp);
            }
            x.clean();
            ...
            polyAdd(v, e2); // v += e2
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cleanBytes"])(tHat, rHat, tmp2, e2);
        ...
        decrypt: (cipherText, privateKey)=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cleanBytes"])(tmp, sk, u);
 ...
 */ function createKyber(opts) {
    ...
    const secretCoder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["splitCoder"])('secretKey', lengths.secretKey, lengths.publicKey, 32, 32);
    const msgLen = 32;
    const seedLen = 64;
    ...
    return Object.freeze({
        ...
        lengths: kemLengths,
        keygen: (seed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["randomBytes"])(seedLen))=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(seed, seedLen, 'seed');
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cleanBytes"])(sk, publicKeyHash);
            return {
                publicKey: publicKey,
                secretKey: secretKey
            };
        ...
        encapsulate: (publicKey, msg = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["randomBytes"])(msgLen))=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(publicKey, lengths.publicKey, 'publicKey');
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(msg, msgLen, 'message');
            // FIPS-203 includes additional verification check for modulus
            const eke = publicKey.subarray(0, 384 * opts.K);
            // Copy because of inplace encoding
            const ek = KPKESecretCoder.encode(KPKESecretCoder.decode((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["copyBytes"])(eke)));
            // (Modulus check.) Perform the computation ek ← ByteEncode12(ByteDecode12(eke)).
            // If ek = ̸ eke, the input is invalid. (See Section 4.2.1.)
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["equalBytes"])(ek, eke)) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cleanBytes"])(ek);
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cleanBytes"])(kr.subarray(32));
            return {
                cipherText: cipherText,
        ...
        decapsulate: (cipherText, secretKey)=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(secretKey, secretCoder.bytesLen, 'secretKey'); // 768*k + 96
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(cipherText, lengths.cipherText, 'cipherText'); // 32(du*k + dv)
            // test ← H(dk[384𝑘 ∶ 768𝑘 + 32])) .
            const k768 = secretCoder.bytesLen - 96;
            const start = k768 + 32;
            const test = HASH256(secretKey.subarray(k768 / 2, start));
            // If test ≠ dk[768𝑘 + 32 ∶ 768𝑘 + 64], then input checking has failed.
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["equalBytes"])(test, secretKey.subarray(start, start + 32))) throw new Error('invalid secretKey: hash check failed');
            ...
            const isValid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["equalBytes"])(cipherText, cipherText2);
            const Kbar = KDF.create({
                dkLen: 32
            }).update(z).update(cipherText).digest();
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cleanBytes"])(msg, cipherText2, !isValid ? Khat : Kbar);
...
function shakePRF(dkLen, key, nonce) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$sha3$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shake256"].create({
        dkLen
...
const opts = /* @__PURE__ */ (()=>({
        HASH256: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$sha3$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sha3_256"],
        HASH512: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$sha3$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sha3_512"],
        KDF: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$sha3$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shake256"],
        XOF: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$_crystals$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["XOF128"],
        PRF: shakePRF
    }))();
...
const __tests = /* @__PURE__ */ (()=>Object.freeze({
        Compress_d: (x, d)=>{
            ...
            return compress(d).encode(x) & (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMask"])(d);
        },
        Decompress_d: (y, d)=>{
        ...
        SamplePolyCBD: (B, eta)=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(B, 64 * eta, 'B');
            return sampleCBDBytes(B, eta);
        },
        SampleNTT: (B)=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["abytes"])(B, 34, 'B');
            const xof = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$post$2d$quantum$2f$_crystals$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["XOF128"])(B.subarray(0, 32));
            try {
...
//# sourceMappingURL=_35b77ce2._.js.map